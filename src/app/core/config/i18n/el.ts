  ...
  data: {
    ...
    FIELDS: {
      ...
      OFFER: {
        ...
        SUBTITLE: {
          ...
          DESC: 'Μια πρόταση που να συνοψίζει την προσφορά'
        },
        DESCRIPTION: {
          TITLE: 'Περιγραφή',
      ...
      POST: {
        ...
        SUBTITLE: {
          ...
          DESC: 'Μια πρόταση που να συνοψίζει την ανάρτηση'
        },
        CONTENT: {
          TITLE: 'Περιεχόμενο',
        ...
        ACCESS: {
          ...
          DESC: 'Επιλέξτε σε ποιούς/ες θα είναι ορατή η ανάρτηση'
        },
        ACCESS_CHOICES: {
          A: 'Δημόσιο',
      ...
      EVENT: {
        ...
        SUBTITLE: {
          TITLE: 'Υπότιτλος',
          PLACEHOLDER: 'Υπότιτλος',
          DESC: 'Μια πρόταση που να συνοψίζει την εκδήλωση'
        },
        DESCRIPTION: {
          TITLE: 'Περιεχόμενο',
          PLACEHOLDER: 'Περιεχόμενο',
        ...
        DATE: {
          TITLE: 'Ημερομηνία',
          PLACEHOLDER: 'Ημερομηνία',
          DESC: 'Η ημερομηνία της εκδήλωσης.'
        },
        TIME: {
          TITLE: 'Ώρα',
          PLACEHOLDER: 'Ώρα',
        ...
        LOCATION: {
          ...
          DESC: 'Τοποθεσία της εκδήλωσης.'
        },
        ACCESS: {
          TITLE: 'Πρόσβαση',
          PLACEHOLDER: 'Πρόσβαση',
          DESC: 'Επιλέξτε σε ποιούς/ες θα είναι ορατή η εκδήλωση'
        },
        ACCESS_CHOICES: {
          A: 'Δημόσια',
          B: 'Στα εγγεγραμμένα μέλη',
      ...
      MICROCREDIT_CAMPAIGN: {
        ...
        MANAGE: {
          TITLE: 'Διαχείριση συμμετοχών',
          CONTENT: 'Εδώ μπορείτε να διαχειριστείτε τις συμμετοχές στην καμπάνια της. Θα πρέπει σε κάθε τρόπο πληρωμής να αναζητείτε την Ταυτότητα Πληρωμής ώστε να επιβεβαιώσετε ότι οι υποστηρικτές έχουν δώσει τα χρήμματα που έχουν υποσχεθεί.'
        },
        TITLE: {
          TITLE: 'Τίτλος',
        ...
        TYPE_CHOICES: {
          A: 'Εξαργυρώσιμη με επιλογή εύρους ποσού',
          B: 'Εξαργυρώσιμη με σταθερό ποσό',
          C: 'Δωρεά'
        },
        SUPPORT_STARTS: {
        ...
        REDEEMABLE: 'Είναι εξαργυρώσιμη (ή αποτελεί Δωρεά);',
        SUBMIT_DRAFT: 'Αποθήκευση ως Πρόχειρο',
        SUBMIT_CAMPAIGN: 'Δημοσίευση',
        SUBSECTIONS: {
          BASIC: 'Βασικές Πληροφορίες',
    ...
    MESSAGE: {
      SUCCESS: {
        ...
        ACCOUNT_DELETED: 'Ο Λογαρισμός σας διαγράφηκς επιτυχώς',
    ...
    SETTINGS: {
      ...
      DEACTIVATE_DESC: 'Απενεργοποιόντας το λογαρισμός σας δεν θα έχετε πρόσβαση σε αυτόν, ούτε στις λειτουργίες που παρέχονται. Σε περίπτωση που μελλοντικά επιθυμείτε την επανενεργοποίσηση του θα χρειαστεί να επικοινωνήσετε με το διαχειριστή',
      DEACTIVATE_CONFRIRM: 'Είστε σίγουρος/η ότι θέλετε να απενεργοποιήσετε το λογαρισμό σας',
      DELETE: 'Διαγραφή Λογαριασμού',
      DELETE_DESC: 'Έαν διαγράψετε το λογαρισμό σας όλα τα δεδομένα σας θα αφαιρεθούν από την πλατφόρμα',
      DELETE_CONFRIRM: 'Είστε σίγουρος/η ότι θέλετε να διαγράψετε το λογαρισμό σας',
    ...
    CAMPAIGN: {
      ...
      TARGET: 'Στόχος',
      PLEDGE: 'Στήριξε',
      PLEDGE_DISABLE_TIME: '*Δεν μπορείται να προσθέσετε μια "Υποστήριξη" εκτός της περιόδου υποστήριξης',
      PLEDGE_DISABLE_AMOUNT: '*Δυστυχώς, το απαιτούμενο ποσό έχει συμπληρωθεί',
    ...
    SUPPORT: {
      ...
      FILTER: {
        TEXT: {
          TITLE: 'Ταυτότητα Πληρωμής',
          PLACEHOLDER: 'Ταυτότητα Πληρωμής'
        },
        SELECT: {
