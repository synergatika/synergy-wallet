...
import { StepperPartnerLoyaltyPointlessOfferComponent } from './stepper-partner-loyalty_pointless_offer.component';
...
const routes: Routes = [
    {
        path: '',
        component: StepperPartnerLoyaltyPointlessOfferComponent,
    }
];
...
@NgModule({
    ...
    exports: [StepperPartnerLoyaltyPointlessOfferComponent],
    declarations: [
        StepperPartnerLoyaltyPointlessOfferComponent,
...
export class StepperPartnerLoyaltyPointlessOfferModule {
    static forRoot(): ModuleWithProviders<StepperPartnerLoyaltyPointlessOfferModule> {
        return {
            ngModule: StepperPartnerLoyaltyPointlessOfferModule,
            providers: [
